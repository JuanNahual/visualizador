...
class Widgets(QWidget):
    ...
    def initUI(self):
      ...
      # ======================== WIDGETS ===========================
        ...
        framePrincipal.setFixedSize(1062, 803)
        framePrincipal.move(10, 10)

        frame = QFrame(framePrincipal)
        frame.setFixedSize(840, 680)
        frame.move(10, 10)
      ...
      # =================== BOTONES (QPUSHBUTTON) ==================
        ...
        self.buttonCargar = QPushButton("Cargar carpeta", self)
        ...
        self.buttonselec = QPushButton("Seleccionar imagen", self)
        self.buttonselec.setCursor(Qt.PointingHandCursor)
        self.buttonselec.setFixedSize(325, 70)
        self.buttonselec.move(10, 10)
      ...
      # ===================== CONECTAR SEÑALES =====================
        ...
        self.buttonselec.clicked.connect(self.elegir)
    ...
    def elegir(self):
        if self.imagenesCarpeta:
            ...
            if nombre in self.lista:
                ...
                shutil.copy(imagen, "C:/Users/JUANI/Pictures/Carpetapedido/"+nombre)
